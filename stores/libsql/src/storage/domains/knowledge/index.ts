...
export class KnowledgeLibSQL extends KnowledgeStorage {
  ...
  async #queryKnowledge(
    ...
    if (!node || !isKnowledgeScopeVisible(node.scope, scope)) return { records: [] };
    const key = knowledgeScopeKey(scope);
