...
- Fixed a chat-library security advisory by updating the Slack and Telegram adapters to 4.37.0. Channel provider APIs are unchanged. ([#24027](https://github.com/mastra-ai/mastra/pull/24027))
