...
| `omScope` | `'thread' \| 'resource'` | Auto-detected | Observational Memory scope. `'resource'` is [deprecated](https://mastra.ai/docs/memory/observational-memory#resource-scope-deprecated) |
