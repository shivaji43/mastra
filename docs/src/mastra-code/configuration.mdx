...
If you have an Anthropic Claude Max or OpenAI ChatGPT Plus subscription, run `/login` to sign in with an account. You can also run `/connect` and select **Sign in with an account**.
