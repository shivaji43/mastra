...
description: "Deploy a complete Mastra server and Studio to an ephemeral E2B, Daytona, or Vercel sandbox and receive a public URL for testing and previews."
packages:
