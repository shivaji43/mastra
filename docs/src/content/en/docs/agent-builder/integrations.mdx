...
This page covers Builder-specific connection setup, scope selection, and management. To register a provider and enable its toolkits, see [Tools](/docs/editor/tools).
...
1. In the Builder, [connect the toolkit](#connect-a-toolkit) and authorize the connection.
