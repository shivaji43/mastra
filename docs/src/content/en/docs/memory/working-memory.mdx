...
description: "Persist user profiles, preferences, and application data with Mastra working memory using resource- or thread-scoped templates and storage adapters."
packages:
  - "@mastra/core"
  - "@mastra/libsql"
  - "@mastra/memory"
