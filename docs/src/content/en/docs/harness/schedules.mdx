...
description: "Schedule Mastra agents with cron expressions, recurring prompts, optional thread delivery, lifecycle hooks, and APIs for managing scheduled runs."
packages:
  - "@mastra/core"
  - "@mastra/client-js"
---
