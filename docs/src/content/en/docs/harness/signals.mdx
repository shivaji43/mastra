...
description: "Send real-time messages or contextual data into a Mastra agent thread immediately or queue them for the next turn with configurable signal behavior."
packages:
  - "@mastra/core"
  - "@mastra/client-js"
---
