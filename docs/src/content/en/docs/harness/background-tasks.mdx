...
description: "Run long-lived Mastra tool calls and subagents as background tasks while streams remain open, with configurable LLM behavior and completion events."
packages:
  - "@mastra/core"
  - "@mastra/memory"
---
