...
```typescript {7-10} title="src/mastra/workflows/test-workflow.ts" oxfmt:false
...
```typescript oxfmt:false {14,18,29-32} title="src/mastra/workflows/test-workflow.ts"
import { createWorkflow, createStep } from "@mastra/core/workflows";
import { z } from "zod";
...
```typescript oxfmt:false {8} title="src/mastra/workflows/test-workflow.ts"
...
```typescript oxfmt:false {7} title="src/mastra/workflows/test-workflow.ts"
import { createWorkflow, createStep } from "@mastra/core/workflows";
import { z } from "zod";
