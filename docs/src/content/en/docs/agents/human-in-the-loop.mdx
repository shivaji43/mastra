...
description: "Add human-in-the-loop controls to Mastra agents with tool approval and suspended execution, so people can provide input before a run resumes or stops."
packages:
  - "@mastra/core"
  - "@mastra/libsql"
  - "@mastra/memory"
