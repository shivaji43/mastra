...
description: "Generate validated, typed structured output from Mastra agents with JSON Schema, Zod, or Valibot, including streaming and tool-enabled responses."
packages:
  - "@mastra/core"
---
