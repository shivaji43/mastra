...
Version overrides propagate automatically through delegation. See [Subagent versioning](/docs/editor/overview#sub-agent-versioning) for details on resolution order and server API usage.

## Related

- [Background tasks](/docs/long-running-agents/background-tasks)
- [Subagent versioning](/docs/editor/overview#sub-agent-versioning)
