...
description: "Understand deprecated Mastra agent networks, including multi-agent routing, structured output, tool approvals, and migration to supervisor agents."
packages:
  - "@mastra/core"
  - "@mastra/libsql"
  - "@mastra/memory"
