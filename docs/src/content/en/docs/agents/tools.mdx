---
title: "Tools | Agents"
description: "Create schema-validated Mastra tools that let agents call APIs, query databases, run functions, and invoke agents, workflows, or remote MCP servers."
packages:
  - "@mastra/core"
---
