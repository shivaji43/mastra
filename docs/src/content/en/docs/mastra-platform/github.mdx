...
description: "Connect a GitHub repository to Mastra platform for push-to-deploy workflows, template projects, repository linking, and deploy status tracking."
---
