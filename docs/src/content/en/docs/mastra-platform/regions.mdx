...
description: "Choose the US or EU region for a Mastra platform environment and understand how compute, hosted databases, and observability data are colocated."
---
