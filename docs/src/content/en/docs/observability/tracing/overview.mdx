...
- [Configuration](/docs/observability/config): Base observability config and multiple configs, plus serverless flushing
- [Storage](/docs/observability/storage): Storage routing for traces, logs, and metrics
