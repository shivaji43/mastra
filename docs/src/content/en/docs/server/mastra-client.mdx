...
description: "Use the type-safe Mastra Client SDK from browser applications to call agents, workflows, tools, memory, and server APIs with streaming support."
packages:
  - "@mastra/client-js"
  - "@mastra/core"
  - "@mastra/react"
