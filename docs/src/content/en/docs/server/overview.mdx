---
title: "Server"
description: "Configure the Mastra HTTP server to expose agents and workflows through REST APIs with middleware, authentication, streaming, and OpenAI-compatible routes."
packages:
  - "@mastra/core"
---
