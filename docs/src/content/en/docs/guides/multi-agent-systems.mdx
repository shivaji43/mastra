...
description: "Choose a Mastra multi-agent architecture by comparing handoffs, workflows, supervisors, and council patterns for delegation, control, and collaboration."
packages:
  - "@mastra/core"
---
