...
The [Mastra CLI](/reference/cli/mastra) gives your coding agent a direct line to your Mastra runtime.
...
Install the [Mastra skills](#mastra-skills) to teach your agent how to use the CLI. See the [CLI commands reference](/reference/cli/mastra) for the full list of available commands.
...
The [`create-mastra`](/reference/cli/create-mastra) command installs Mastra skills automatically. It doesn't configure the MCP docs server. Add the server manually when you need MCP-specific tools such as the migration tool.
