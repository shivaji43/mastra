...
description: "Execute commands in AWS Bedrock AgentCore Runtime sessions from Mastra workspaces, with session management, environment variables, and file operations."
packages:
  - "@mastra/agentcore"
---
