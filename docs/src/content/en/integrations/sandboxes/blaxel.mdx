...
description: "Run Mastra workspace commands in isolated Blaxel cloud sandboxes with custom images, resource limits, storage mounts, and lifecycle management."
packages:
  - "@mastra/blaxel"
---
