...
description: "Integrate Mastra with NestJS using the server adapter module, expose agent and workflow routes, inject MastraService, and test the application."
packages:
  - '@mastra/core'
---
