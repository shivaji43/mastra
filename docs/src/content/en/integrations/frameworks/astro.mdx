...
description: "Build a tool-calling Mastra agent in Astro, create server and chat routes, add AI SDK UI and AI Elements, and test the interactive chat experience."
packages:
  - '@mastra/core'
---
