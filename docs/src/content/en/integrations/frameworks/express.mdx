...
description: "Integrate Mastra with an Express application using the server adapter to expose agent and workflow HTTP routes and test a tool-calling agent."
packages:
  - '@mastra/core'
---
