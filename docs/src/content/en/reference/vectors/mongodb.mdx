...
description: "The MongoDBVector class provides vector search using MongoDB Vector Search. It enables efficient similarity search and metadata filtering within your MongoDB collections."
packages:
  - "@mastra/core"
  - "@mastra/fastembed"
  - "@mastra/memory"
