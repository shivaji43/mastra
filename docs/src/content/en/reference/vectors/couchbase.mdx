...
description: "The CouchbaseVector class provides vector search using Couchbase Vector Search. It enables efficient similarity search and metadata filtering within your Couchbase collections."
packages:
  - "@mastra/couchbase"
---
