...
description: "The createMultiTurnJudgeScorer() function creates an LLM-as-judge scorer that grades a whole conversation against a single plain-English criterion."
packages:
  - "@mastra/evals"
---
