...
Stored workflows are workflow definitions expressed as JSON. The server persists each definition and registers it as a runnable workflow. See [Stored workflows](/docs/workflows/stored-workflows) for the definition format.
