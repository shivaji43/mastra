...
description: "Use the AgentController class as a shared host for Session instances, then create sessions and manage conversation state, events, and run control."
packages:
  - "@mastra/core"
---
