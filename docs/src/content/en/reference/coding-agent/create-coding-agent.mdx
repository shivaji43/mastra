...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'Processor[]',
    description:
      'Error processors for the agent. When omitted, defaults to unknown stream-error retries with specialized ECONNRESET and bad-request policies, plus PrefillErrorHandler, ProviderHistoryCompat, and CyberRefusalHandler.',
    isOptional: true,
  },
  {
    name: 'outputProcessors',
    type: 'Processor[]',
    description: 'Output processors for the agent. When omitted, defaults to CyberRefusalHandler.',
    isOptional: true,
  },
  {
    name: 'goal',
...
| `outputProcessors` | [`CyberRefusalHandler`](/reference/processors/cyber-refusal-handler). |
