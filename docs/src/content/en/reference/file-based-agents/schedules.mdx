...
description: "A file-based agent discovers schedules from its schedules/ directory. Each file declares one recurring task: a cron expression plus what the agent should do when it fires."
packages:
  - "@mastra/core"
---
