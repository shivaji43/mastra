...
description: 'Configure a Mastra instance with agents, workflows, storage, logging, observability, server options, processors, deployers, and other supported services.'
packages:
  - '@mastra/core'
---
