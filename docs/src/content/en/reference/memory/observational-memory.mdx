    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            defaultValue:
              '{ temperature: 0.3 (temperature-capable models), maxOutputTokens: 100_000 (default model selection only) }',
            properties: [
              {
                type: 'ObservationalMemoryModelSettings',
                parameters: [
                  {
                    ...
                    isOptional: true,
                    defaultValue: '0.3 (models that support temperature only)',
                  },
                  {
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            defaultValue:
              '{ temperature: 0 (temperature-capable models), maxOutputTokens: 100_000 (default model selection only) }',
            properties: [
              {
                type: 'ObservationalMemoryModelSettings',
                parameters: [
                  {
                    ...
                    isOptional: true,
                    defaultValue: '0 (models that support temperature only)',
                  },
                  {
                    name: 'maxOutputTokens',
                    type: 'number',
