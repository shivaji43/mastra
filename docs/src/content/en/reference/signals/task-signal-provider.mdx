...
description: "Register TaskSignalProvider to add task_write, task_update, task_complete, and task_check tools with TaskStateProcessor-backed durable task state."
packages:
  - "@mastra/core"
---
