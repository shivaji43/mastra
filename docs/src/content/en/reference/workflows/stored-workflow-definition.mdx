---
title: "Reference: Stored workflow definition | Workflows"
description: "Reference for the JSON definition format used to persist and register stored workflows."
packages:
  - "@mastra/core"
---
...
A stored workflow definition is a JSON-compatible `StoredWorkflowGraph` accepted by [`Mastra.addStoredWorkflow()`](/reference/core/addStoredWorkflow), the stored-workflow server routes, and the Client SDK workflows API.

See [Stored workflows](/docs/workflows/stored-workflows) for a complete setup and usage example.
...
- [Use stored workflows](/docs/workflows/stored-workflows)
